...
import { useNotifications } from '@/app/dashboard/layout'; // Path assumed for context
...
export default function ChatPage() {
                ...
                try {
                    ...
                    if (userIdFromUrl) {
                        ...
                        if (userToSelect) {
                            ...
                            clearUnreadSender(userIdFromUrl); // Clear indicator on load/selection
                        } else {
                            try {
    ...
    const handleUserSelect = (user) => {
        ...
        clearUnreadSender(user._id); // Clear indicator on click
    };
